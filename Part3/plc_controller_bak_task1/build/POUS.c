...
void PLC_CONTROLLER_init__(PLC_CONTROLLER *data__, BOOL retain) {
  __INIT_VAR(data__->IN_START_STOP,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->IN_TEMP_UP,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->IN_TEMP_DOWN,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->IN_EMERGENCY_STOP,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_STATUS_LED,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_DISPLAY_LED0,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_DISPLAY_LED1,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_DISPLAY_LED2,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_DISPLAY_LED3,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_DISPLAY_LED4,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->OUT_DISPLAY_LED5,__BOOL_LITERAL(FALSE),retain)
...
void PLC_CONTROLLER_body__(PLC_CONTROLLER *data__) {
  ...
  __SET_VAR(data__->,_TMP_AND22_OUT,,AND__BOOL__BOOL(
    ...
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->IN_TEMP_UP,),
  ...
  __SET_VAR(data__->,_TMP_AND5_OUT,,AND__BOOL__BOOL(
    ...
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->IN_TEMP_DOWN,),
    (BOOL)__GET_VAR(data__->_TMP_NOT21_OUT,)));
  ...
  __SET_VAR(data__->R_TRIG0.,CLK,,__GET_VAR(data__->IN_START_STOP,));
  ...
  __SET_VAR(data__->,OUT_STATUS_LED,,__GET_VAR(data__->HEATING_ON,));
  ...
  __SET_VAR(data__->,OUT_DISPLAY_LED0,,__GET_VAR(data__->_TMP_OR140_OUT,));
  ...
  __SET_VAR(data__->,OUT_DISPLAY_LED3,,__GET_VAR(data__->_TMP_OR20_OUT,));
  ...
  __SET_VAR(data__->,OUT_DISPLAY_LED1,,__GET_VAR(data__->_TMP_OR35_OUT,));
  ...
  __SET_VAR(data__->,OUT_DISPLAY_LED4,,__GET_VAR(data__->_TMP_OR46_OUT,));
  ...
  __SET_VAR(data__->,OUT_DISPLAY_LED2,,__GET_VAR(data__->_TMP_OR53_OUT,));
  ...
  __SET_VAR(data__->,OUT_DISPLAY_LED5,,__GET_VAR(data__->_TMP_OR64_OUT,));
  ...
  __SET_VAR(data__->R_TRIG3.,CLK,,__GET_VAR(data__->IN_EMERGENCY_STOP,));
