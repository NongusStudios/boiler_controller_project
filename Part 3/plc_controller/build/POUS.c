...
void PLC_CONTROLLER_init__(PLC_CONTROLLER *data__, BOOL retain) {
  __INIT_LOCATED(BOOL,__IX100_2,data__->IN_START_STOP,retain)
  __INIT_LOCATED_VALUE(data__->IN_START_STOP,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__IX100_0,data__->IN_TEMP_UP,retain)
  __INIT_LOCATED_VALUE(data__->IN_TEMP_UP,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__IX100_1,data__->IN_TEMP_DOWN,retain)
  __INIT_LOCATED_VALUE(data__->IN_TEMP_DOWN,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__IX100_3,data__->IN_EMERGENCY_STOP,retain)
  __INIT_LOCATED_VALUE(data__->IN_EMERGENCY_STOP,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_7,data__->OUT_STATUS_LED,retain)
  __INIT_LOCATED_VALUE(data__->OUT_STATUS_LED,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_6,data__->OUT_DISPLAY_LED0,retain)
  __INIT_LOCATED_VALUE(data__->OUT_DISPLAY_LED0,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_5,data__->OUT_DISPLAY_LED1,retain)
  __INIT_LOCATED_VALUE(data__->OUT_DISPLAY_LED1,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_4,data__->OUT_DISPLAY_LED2,retain)
  __INIT_LOCATED_VALUE(data__->OUT_DISPLAY_LED2,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_3,data__->OUT_DISPLAY_LED3,retain)
  __INIT_LOCATED_VALUE(data__->OUT_DISPLAY_LED3,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_2,data__->OUT_DISPLAY_LED4,retain)
  __INIT_LOCATED_VALUE(data__->OUT_DISPLAY_LED4,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX100_1,data__->OUT_DISPLAY_LED5,retain)
...
void PLC_CONTROLLER_body__(PLC_CONTROLLER *data__) {
  ...
  __SET_VAR(data__->R_TRIG0.,CLK,,__GET_LOCATED(data__->IN_START_STOP,));
  ...
  __SET_VAR(data__->CTUD1.,PV,,1000);
  ...
  __SET_VAR(data__->PID0.,AUTO,,__BOOL_LITERAL(TRUE));
  __SET_VAR(data__->PID0.,PV,,__GET_VAR(data__->TEMPERATURE,));
  __SET_VAR(data__->PID0.,SP,,__GET_VAR(data__->_TMP_INT_TO_REAL209_OUT,));
  __SET_VAR(data__->PID0.,KP,,-0.5);
  __SET_VAR(data__->PID0.,TR,,1000.0);
  __SET_VAR(data__->PID0.,TD,,0.5);
  ...
  __SET_VAR(data__->R_TRIG3.,CLK,,__GET_LOCATED(data__->IN_EMERGENCY_STOP,));
